...
![An example of a matplotlib histogram](fig/03_matplotlib_histogram.jpg){alt="An example of a matplotlib histogram"}
...
![Example of matplotlib customised plot](fig/03_matplotlib_stacked_histogram.jpg){alt="Example of a matplotlib customised plot"}
